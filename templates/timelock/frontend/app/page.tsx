  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Timelock Multisig</h1>
          <p className="text-gray-600">Manage multisig transactions with mandatory execution delay</p>
        </div>
